...
sound.Add({
	...
	level = 84,
	pitch = 100,
	sound = {"foley/foot/damage/step_land_damage_01.wav", "foley/foot/damage/step_land_damage_02.wav"}
})
...
sound.Add({
	...
	level = 84,
	pitch = 100,
	sound = {"foley/foot/damage/step_land_damage_death_01.wav", "foley/foot/damage/step_land_damage_death_02.wav"}
})
...
hook.Add("PlayerFootstep", "CustomFootstepVolume", function(ply, pos, footStepped, snd, volume)
	...
	ply:EmitSound(snd, soundLevel, 100, math.min(fsVol, 1))
	Raycast26(ply)
