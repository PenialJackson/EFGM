...
local quickmodifiers = {
    ...
    ["DamageMin"] = GetConVar("sv_efgm_damage_global"),
    ["DamageMax"] = GetConVar("sv_efgm_damage_global"),
    ["Spread"] = GetConVar("sv_efgm_weapons_spread"),
    ["DispersionSpread"] = GetConVar("sv_efgm_weapons_dispersion"),
    ["Recoil"] = GetConVar("sv_efgm_weapons_recoil"),
    ["VisualRecoil"] = GetConVar("sv_efgm_weapons_visual_recoil"),
    ["AimDownSightsTime"] = GetConVar("sv_efgm_weapons_ads"),
    ["SprintToFireTime"] = GetConVar("sv_efgm_weapons_sprint"),
    ["DamageRand"] = 1,
    ["PhysBulletMuzzleVelocity"] = GetConVar("sv_efgm_weapons_velocity"),
    ["RPM"] = GetConVar("sv_efgm_weapons_rpm"),
    ["HeadshotDamage"] = GetConVar("sv_efgm_damage_global_headshot"),
    ["MalfunctionMeanShotsToFail"] = GetConVar("sv_efgm_damage_global_malfunction"),
}
