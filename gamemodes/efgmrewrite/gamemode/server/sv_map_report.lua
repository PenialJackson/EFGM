if GetConVar("efgm_derivesbox"):GetInt() == 1 then
	concommand.Add("efgm_debug_mapreport", function(ply, cmd, args)
		...
		print("File (" .. (args[1] or "map") .. "_mapreport.json" .. ") written to (garrysmod/data/efgmdev/)!")
	end)
	...
	concommand.Add("efgm_debug_mapreport_final", function(ply, cmd, args)
		...
		print("File (" .. (args[1] or "map") .. "_mapreport_FINAL.json" .. ") written to (garrysmod/data/efgmdev/)!")
	end)
end