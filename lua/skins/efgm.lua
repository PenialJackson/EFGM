...
SKIN.PrintName  = "Escape From Garry's Mod Derma Skin"
SKIN.Author		= "Penial"
SKIN.DermaVersion	= 1
...
function SKIN:PaintButton(panel, w, h)
	...
	if (panel.Depressed || panel:IsSelected() || panel:GetToggle()) then return self.tex.Button_Down(0, 0, w, h) end
...
function SKIN:PaintCheckBox(panel, w, h)
	if (panel:GetChecked()) then
		if (panel:GetDisabled()) then self.tex.CheckboxD_Checked(0, 0, w, h) else self.tex.Checkbox_Checked(0, 0, w, h) end
	else
		if (panel:GetDisabled()) then self.tex.CheckboxD(0, 0, w, h) else self.tex.Checkbox(0, 0, w, h) end
	end
end
...
function SKIN:PaintRadioButton(panel, w, h)
	if (panel:GetChecked()) then
		if (panel:GetDisabled()) then self.tex.RadioButtonD_Checked(0, 0, w, h) else self.tex.RadioButton_Checked(0, 0, w, h) end
	else
		if (panel:GetDisabled()) then self.tex.RadioButtonD(0, 0, w, h) else self.tex.RadioButton(0, 0, w, h) end
	end
end

-- expand button
function SKIN:PaintExpandButton(panel, w, h)
	if (!panel:GetExpanded()) then self.tex.TreePlus(0, 0, w, h) else self.tex.TreeMinus(0, 0, w, h) end
end
...
function SKIN:PaintMenu(panel, w, h)
	if (panel:GetDrawColumn()) then self.tex.MenuBG_Column(0, 0, w, h) else self.tex.MenuBG(0, 0, w, h) end
end
...
function SKIN:PaintMenuOption(panel, w, h)
	...
	if (panel.m_bBackground && (panel.Hovered || panel.Highlight)) then self.tex.MenuBG_Hover(0, 0, w, h) end

	if (panel:GetRadio()) then
		if (panel:GetChecked()) then
			if (panel:GetDisabled()) then self.tex.RadioButtonD_Checked(5, h / 2 - 7, 15, 15) else self.tex.RadioButton_Checked(5, h / 2 - 7, 15, 15) end
		else
			if (panel:GetDisabled()) then self.tex.RadioButtonD(5, h / 2 - 7, 15, 15) else self.tex.RadioButton(5, h / 2 - 7, 15, 15) end
		end
	else
...
function SKIN:PaintWindowCloseButton(panel, w, h)
	...
	if (panel.Depressed || panel:IsSelected()) then return self.tex.Window.Close_Down(0, 0, w, h) end
...
function SKIN:PaintWindowMinimizeButton(panel, w, h)
	...
	if (panel.Depressed || panel:IsSelected()) then return self.tex.Window.Mini_Down(0, 0, w, h) end
...
function SKIN:PaintWindowMaximizeButton(panel, w, h)
	...
	if (panel.Depressed || panel:IsSelected()) then return self.tex.Window.Maxi_Down(0, 0, w, h) end
...
function SKIN:PaintButtonDown(panel, w, h)
	...
	if (panel.Depressed || panel:IsSelected()) then return self.tex.Scroller.DownButton_Down(0, 0, w, h) end
...
function SKIN:PaintButtonUp(panel, w, h)
	...
	if (panel.Depressed || panel:IsSelected()) then return self.tex.Scroller.UpButton_Down(0, 0, w, h) end
...
function SKIN:PaintButtonLeft(panel, w, h)
	...
	if (panel.Depressed || panel:IsSelected()) then return self.tex.Scroller.LeftButton_Down(0, 0, w, h) end
...
function SKIN:PaintButtonRight(panel, w, h)
	...
	if (panel.Depressed || panel:IsSelected()) then return self.tex.Scroller.RightButton_Down(0, 0, w, h) end
...
function SKIN:PaintComboDownArrow(panel, w, h)
	...
	if (panel.ComboBox.Depressed || panel.ComboBox:IsMenuOpen()) then return self.tex.Input.ComboBox.Button.Down(0, 0, w, h) end
...
function SKIN:PaintComboBox(panel, w, h)
	...
	if (panel.Depressed || panel:IsMenuOpen()) then return self.tex.Input.ComboBox.Down(0, 0, w, h) end
...
function SKIN:PaintListViewLine(panel, w, h)
	if (panel:IsSelected()) then self.tex.Input.ListBox.EvenLineSelected(0, 0, w, h) elseif (panel.Hovered) then self.tex.Input.ListBox.Hovered(0, 0, w, h) elseif (panel.m_bAlt) then self.tex.Input.ListBox.EvenLine(0, 0, w, h) end
end
...
derma.DefineSkin("Escape From Garry's Mod Derma Skin", "Custom Derma skin for use in Escape From Garry's Mod", SKIN);
derma.RefreshSkins();